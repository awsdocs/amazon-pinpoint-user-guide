...
For information about short code pricing, see [Amazon Pinpoint Pricing](aws.amazon.com/pinpoint/pricing/)\.
...
After receiving your request, AWS works with the wireless carriers to provision your short code on your behalf\. This provisioning process takes 8–12 weeks\.
...
**Message content:**
   ...
   + An example of each type of message that you'll send with your short code\.

   + The frequency with which users will receive messages from your short code\. For example, "3 messages per week"\.
...
1. Under **Keywords**, verify your keywords and responses\. The console shows the keyword responses that you provided to AWS Support\.
