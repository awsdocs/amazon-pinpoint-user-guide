...
+ [Amazon Pinpoint projects](projects.md)
...
+ [Amazon Pinpoint channels](channels.md)
   ...
   + [Amazon Pinpoint email channel](channels-email.md)
      ...
      + [Using dedicated IP addresses with Amazon Pinpoint](channels-email-dedicated-ips.md)
         ...
         + [Viewing a list of dedicated IP addresses that are associated with your account](channels-email-dedicated-ips-viewing.md)
   ...
   + [Amazon Pinpoint SMS channel](channels-sms.md)
      ...
      + [Originating identities for SMS messages](channels-sms-originating-identities.md)
         + [Choosing the right type of origination identity for your use case](channels-sms-originating-identities-choosing.md)
...
+ [Amazon Pinpoint settings](settings.md)
   ...
   + [SMS and voice settings](settings-sms.md)
      + [10DLC](settings-sms-10dlc.md)
         + [Registering a company or brand for use with 10DLC](settings-sms-10dlc-register-company.md)
         + [Editing or deleting a registered company](settings-sms-10dlc-modify-company.md)
         + [Registering a 10DLC campaign](settings-sms-10dlc-register-campaign.md)
         + [Editing or deleting a 10DLC campaign](settings-sms-10dlc-modify-campaign.md)
         + [Associating an existing long code with a 10DLC campaign](settings-sms-10dlc-associate-long-code.md)
         + [Setting up 10DLC cross-account access](settings-sms-10dlc-configure-cross-account-access.md)
