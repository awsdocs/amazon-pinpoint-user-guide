...
To update your SMS settings, use the **SMS and voice settings** page\. For more information, see [SMS and voice settings](settings-sms.md)\.
...
**Note**  
For toll\-free numbers, opt\-out is carrier\-managed\. The only supported opt\-out keyword for a toll\-free number is STOP\. You will be unable to change or edit this keyword\.